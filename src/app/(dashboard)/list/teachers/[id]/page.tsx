    ...
    <div className="flex-1 p-4 flex flex-col gap-4 xl:flex-row">
      ...
      <div className="w-full xl:w-2/3">
          ...
          <div className="bg-lamaSky py-6 px-4 rounded-md flex-1 flex gap-4">
            ...
            <div className="w-2/3 flex flex-col justify-between gap-4">
              ...
              <p className="text-sm text-gray-500">
                Senior Mathematics faculty with over 15 years of experience in CBSE curriculum and competitive exam coaching.
              </p>
          ...
          <div className="flex-1 flex gap-4 justify-between flex-wrap">
            ...
            <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
              ...
              <div className="">
                ...
                <span className="text-sm text-gray-400">Weekly Lessons</span>
              </div>
            </div>
            {/* CARD */}
            <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
        ...
        <div className="mt-4 bg-white rounded-md p-4 h-[800px]">
          <h1 className="text-lg font-semibold">Teacher&apos;s Class Schedule (IST)</h1>
          <BigCalendar />
        </div>
      </div>
      {/* RIGHT */}
